...
function Payment() {
    return (
        <div className="flex flex-col items-center justify-center px-6 md:px-20 py-16
            ...
            <div className="max-w-4xl w-full text-center">
                ...
                <div className="grid md:grid-cols-2 gap-10 text-left">
                    <div className="bg-gray-100 dark:bg-gray-800 p-8 rounded-2xl shadow-sm
                ...
                <div className="mt-16">
                    <Link
                        ...
                        className="px-10 py-4 bg-green-600 text-white font-semibold rounded-lg
                                   shadow-md hover:bg-green-700 transition text-lg"
                    >
